...
namespace API.Controllers
{
    ...
    public class PlanoDeAulasController : ControllerBase
    {
        ...
        public PlanoDeAulasController(APIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostPlanoDeAula([FromBody] PlanoDeAula planoDeAula)
        {
            ...
            return CreatedAtAction("GetPlanoDeAula", new { id = planoDeAula.PlanoAulaId }, planoDeAula);
        }
        ...
        {
            return _context.PlanoDeAula.Any(e => e.PlanoAulaId == id);
        }
    }
}